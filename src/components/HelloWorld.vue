  ...
  .my-grid
    ...
    .central  
      ...
      svg#sheet(ref="sheet" :viewBox="viewBoxSet" xmlns="http://www.w3.org/2000/svg" @mousedown="slider.startDrag($event)" @mousemove="mousemove($event,pos)" @wheel="zoom" @mouseleave="slider.stopDrag")
        ...
        rect.mbody(@mouseup="slider.stopDrag" @mouseleave="slider.draggingCenter =!slider.draggingCenter" @mouseenter="slider.draggingCenter =!slider.draggingCenter" :x="wline.middle.x" :y="wline.middle.y" :width="wline.middle.w" :height="wline.middle.h")
